...
let E = new InteractiveButton(0,50,100,50,colArray[2][7],colArray[1][7], colArray[0][7],colArray[0][2], "Ellipse", colArray[0][2]);
let L = new InteractiveButton(100,0,100,50,colArray[2][7],colArray[1][7], colArray[0][7],colArray[0][2], "Line", colArray[0][2]);
let T = new InteractiveButton(100,50,100,50,colArray[2][7],colArray[1][7], colArray[0][7],colArray[0][2], "Triangle", colArray[0][2]);
...
let buttonSet = [R,E,L,T,W,U,Re,Ci];
